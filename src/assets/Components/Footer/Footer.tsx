...
export const Footer = () => {
  return (
   <footer>
    ...
    <Text variant={'h2'} style={{color:'#963949',fontSize:25,fontFamily:"Aguafina Script",fontStyle:'cursive',textAlign:'left'}} >Follow us Palisirie</Text>
    <div className={styles['socials-align']}>
     ...
     <Text variant={'h3'} style={{fontFamily: "'Dancing Script', cursive",textAlign:'right',color:'rgb(20,20,20)',fontSize:10}}>Thanks for the support</Text>
      </div>
      </div>
   </footer>
  )
