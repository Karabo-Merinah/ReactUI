...
export const Footer = () => {
  return (
   <footer>
    ...
    <Text variant={'h2'} style={{color:'#ECCFC8',fontSize:25,fontFamily:"Aguafina Script",fontStyle:'italic',textAlign:'left'}} >Palisirie Follow us on this socials</Text>
    <div className={styles['socials-align']}>
     ...
     <Text variant={'h3'} style={{fontFamily: "'Cormorant Garamond', serif",textAlign:'right',color:'rgb(20,20,20)'}}>Thanks for the support</Text>
      </div>
      </div>
   </footer>
  )
